...
<html>
    <head>
        ...
        <title>&Uacute;ltimos Mensajer&iacute;a</title>
    ...
    <body>
       ...
       <h1>&Uacute;ltimos Mensajer&iacute;a</h1>
                <%
	...
	try{      
		...
		ResultSet rs = st.executeQuery("SELECT  top 15   m.IdMensajeria idm,m.CodigoCliente as codigo, cl.NombreCliente as nombre,m.Usuario,m.FechaIngreso,m.OrdenPedido,m.Contacto,m.Zona,m.Prioridad,m.ObservacionesMensajeria as om  from  Mensajeria m, Clientes cl where m.CodigoCliente =cl.Codigo    ORDER BY m.IdMensajeria DESC");
