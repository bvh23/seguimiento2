...
try{      
  ...
  <nav id="menu">
      <ul> 
          ...
          --%>
          <li><h2 style="text-decoration: none; color:#000;margin-left: 250px;"> NuevaMensajer&iacute;a </h2></li> 
      </ul>
        </nav>
        ...
        <h:form>
            ...
            <br />
            <h:commandLink action="#{mensajeria.create}" value="Crear" style="text-decoration: none; color:#000;margin-left:-100px;"/>
            <br />
            <br />
            <h:commandLink action="#{mensajeria.listSetup}" value="Ver todos los Registros de  Mensajeria" immediate="true" style="text-decoration: none; color:#000;margin-left:-100px;"/>
            <br />
            <br />
