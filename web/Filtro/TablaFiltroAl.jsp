...
<f:view>
    ...
    try{
        ...
        out.println("<table border=1>");
                                ...
                                out.println("<tr>");
                                    ...
                                    out.println("</th>"); 
                                     out.println("<th style=margin:auto>");
                                         out.println("Observaciones Alquiler");
                                    out.println("</th>");
                                     out.println("<th>");
                            ...
                            if(Nombre!="" ) 
                            {
                        ResultSet rs = st.executeQuery("Select al.IdAlquiler,p.IdProceso,cl.NombreCliente,al.CodigoCliente,al.Usuario,al.OrdenPedido,al.ObservacionesAlquiler,p.Recepcion,al.FechaIngreso,p.Fechadespacho from   Alquiler al, Clientes cl,Proceso p WHERE cl.NombreCliente LIkE '%"+Nombre+"%' and cl.Codigo=al.CodigoCliente and p.CodigoCliente=cl.Codigo and al.IdAlquiler=p.Id");
                            while (rs.next ()){
                            out.println("<tbody>");
                                out.println("<tr>");
                                    out.println("<th>");
                                         out.println(rs.getString("IdAlquiler"));
                                    out.println("</th>");
                                    out.println("<th>");
                                    ...
                                    out.println("<th>");
                                         out.println(rs.getString("ObservacionesAlquiler"));
                                    out.println("</th>");
                        ...
                        ResultSet rs1 = st.executeQuery("Select al.IdAlquiler,p.IdProceso,cl.NombreCliente,al.CodigoCliente,al.Usuario,al.OrdenPedido,al.ObservacionesAlquiler,p.Recepcion,al.FechaIngreso,p.Fechadespacho from   Alquiler al, Clientes cl,Proceso p WHERE cl.Codigo LIkE '"+Codigo+"' and cl.Codigo=al.CodigoCliente and p.CodigoCliente=cl.Codigo and al.IdAlquiler=p.Id");
         
                            while (rs1.next ()){
                            out.println("<tbody>");
                                out.println("<tr>");
                                    out.println("<th>");
                                         out.println(rs1.getString("IdAlquiler"));
                                    out.println("</th>");
                                    out.println("<th>");
                                    ...
                                    out.println("<th>");
                                         out.println(rs1.getString("ObservacionesAlquiler"));
                                    out.println("</th>");
                        ...
                        ResultSet rs2 = st.executeQuery("Select al.IdAlquiler,p.IdProceso,cl.NombreCliente,al.CodigoCliente,al.Usuario,al.OrdenPedido,al.ObservacionesAlquiler,p.Recepcion,al.FechaIngreso,p.Fechadespacho from   Alquiler al, Clientes cl,Proceso p WHERE al.OrdenPedido LIkE '"+OrdenPedido+"' and cl.Codigo=al.CodigoCliente and p.CodigoCliente=cl.Codigo and al.IdAlquiler=p.Id");

                              while (rs2.next ()){
                            out.println("<tbody>");
                                out.println("<tr>");
                                    out.println("<th>");
                                         out.println(rs2.getString("IdAlquiler"));
                                    out.println("</th>");
                                    out.println("<th>");
                                    ...
                                    out.println("<th>");
                                         out.println(rs2.getString("ObservacionesAlquiler"));
                                    out.println("</th>");
                              ...
                              if(Observaciones!="" ) 
                            {
                              ResultSet rs3 = st.executeQuery("Select al.IdAlquiler,p.IdProceso,cl.NombreCliente,al.CodigoCliente,al.Usuario,al.OrdenPedido,al.ObservacionesAlquiler,p.Recepcion,al.FechaIngreso,p.Fechadespacho from   Alquiler al, Clientes cl,Proceso p WHERE al.ObservacionesAlquiler LIkE '%"+Observaciones+"%' and cl.Codigo=al.CodigoCliente and p.CodigoCliente=cl.Codigo and al.IdAlquiler=p.Id");

                              while (rs3.next ()){
                            out.println("<tbody>");
                                out.println("<tr>");
                                    out.println("<th>");
                                         out.println(rs3.getString("IdAlquiler"));
                                    out.println("</th>");
                                    out.println("<th>");
                                    ...
                                    out.println("<th>");
                                         out.println(rs3.getString("ObservacionesAlquiler"));
                                    out.println("</th>");
