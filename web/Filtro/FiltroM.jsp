    ...
    <html>
      ...
      <body>
        <div id="container">
            ...
            String usuario1="Med-recepcion";
            String usuario2="Med-facturacion";
            String usuario3="Med-facturacionAux";
            String usuario4="Med-calidad";
            String usuario5="Med-gerencia";
            ...
            if(  usuario1.equals(nombre1)||usuario2.equals(nombre1)||usuario3.equals(nombre1)||usuario4.equals(nombre1)||usuario5.equals(nombre1)||usuario6.equals(nombre1)||usuario7.equals(nombre1)) 
            {
                %>
                        ...
                        <table style="padding-top: 45px">  
                             <form action="TablaFiltroM.jsp">
                                 <tbody>
                                <tr>
                                    <td style="width:400px; height:27px;font-size: 35px; margin-left:-65px;position: absolute;margin-top: -25px"  ><a style="">Busqueda para Mensajer&iacute;a:</a></td>
                                </tr>
                                <tr>
