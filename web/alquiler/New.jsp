...
try{      
  ...
  <nav id="menu">
      <ul> 
          ...
          --%>
          <li><h2 style="text-decoration: none; color:#000;margin-left: 250px;"> NuevaAlquiler </h2></li> 
      </ul>
        </nav>
        ...
        <h:form>
            ...
            <h:panelGrid columns="2">
                ...
                <h:inputTextarea id="observacionesAlquiler" style="width: 205px" value="#{alquiler.alquiler.observacionesAlquiler}" title="ObservacionesAlquiler" />
